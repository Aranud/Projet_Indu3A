...
void Accelero::slotOnDataExtractedReady(QByteArray p_baDataExtracted)
{
    ...
    m_iXAccelero = ReverseData(p_baDataExtracted.mid(0, 2)).toInt();
    m_iYAccelero = ReverseData(p_baDataExtracted.mid(2, 2)).toInt();
    m_iZAccelero = ReverseData(p_baDataExtracted.mid(4, 2)).toInt();
